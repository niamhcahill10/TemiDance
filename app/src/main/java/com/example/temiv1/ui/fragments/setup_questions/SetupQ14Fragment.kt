...
class SetupQ14Fragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_setup_q14, container, false)
    }
    ...
    private fun onYesSelected() {
        findNavController().navigate(R.id.action_q14Fragment_to_paQ1Fragment)
    }

    private fun onNoSelected() {
        findNavController().navigate(R.id.action_q14Fragment_to_endSessionFragment)
    }
