...
class PaQ4Fragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pa_q4, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        textView = view.findViewById(R.id.q4)
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                findNavController().navigate(R.id.action_paQ4Fragment_to_paQ5Fragment) // Navigate to next fragment once an answer has been selected and user clicks continue
            } else {
                Toast.makeText(
                    requireContext(),
