    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                findNavController().navigate(R.id.action_paQ5Fragment_to_paQ6Fragment) // Navigate to next fragment once an answer has been selected and user clicks continue
            } else {
                Toast.makeText(
                    requireContext(),
