...
class PaQ10Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentScope.launch {
            delay(1000)
            val paq10 = TtsRequest.create("How difficult is it for you to bend down and pick up a small object (e.g. a book) from the floor?", false)
            robot?.speak(paq10)
        }
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                CsvLogger.logEvent("answers", "pa_q10", answerText)
                findNavController().navigate(R.id.action_paQ10Fragment_to_paQ11Fragment) // Navigate to next fragment once an answer has been selected and user clicks continue
            } else {
                Toast.makeText(
                    requireContext(),
