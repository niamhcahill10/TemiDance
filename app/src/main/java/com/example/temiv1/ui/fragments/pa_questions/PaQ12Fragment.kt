...
class PaQ12Fragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pa_q12, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                CsvLogger.logEvent("answers", "pa_q12", answerText)
                findNavController().navigate(R.id.action_paQ12Fragment_to_paQ13Fragment) // Navigate to next fragment once an answer has been selected and user clicks continue
            } else {
                Toast.makeText(
                    requireContext(),
