    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                CsvLogger.logEvent("answers", "pa_q8", answerText)
                findNavController().navigate(R.id.action_paQ8Fragment_to_paQ9Fragment) // Navigate to next fragment once an answer has been selected and user clicks continue
            } else {
                Toast.makeText(
                    requireContext(),
