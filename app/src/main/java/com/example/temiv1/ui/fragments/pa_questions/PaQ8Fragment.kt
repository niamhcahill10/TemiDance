...
class PaQ8Fragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentScope.launch {
            delay(1000)
            val q8 = TtsRequest.create("How difficult is it for you to walk continuously for 10 minutes without stopping?", false)
            robot?.speak(q8)
        }
        ...
        continueButton.setOnClickListener {
            ...
            if (selectedId != -1) {
                findNavController().navigate(R.id.action_paQ8Fragment2_to_paQ9Fragment)
            } else {
                Toast.makeText(
                    requireContext(),
